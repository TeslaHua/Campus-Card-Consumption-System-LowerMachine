#include "include.h"      
unsigned char UID[4],Temp[4];   //IC卡密码存放区
unsigned char Password_Buffer[6]={0xFF,0xFF,0xFF,0xFF,0xFF,0xFF}   ; // 出厂默认密码
unsigned char Write_Buffer[16]={0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,
0x00,0x00,0x02,0x01,0x20,0x15,0x25,0x2A};  //写入的一块数据
/////////////////////////////////////////////////////////////////////
//功    能：端口定义

/////////////////////////////////////////////////////////////////////
void Init_Port(void)  //MFRC522的端口初始化
{    
    P2SEL = 0;
    P1SEL = 0;
...
{
   if(PcdRequest(0x52,Temp)==MI_OK&PcdAnticoll(UID)==MI_OK&PcdSelect(UID)== MI_OK)//寻卡成功
